...
\caption{初期解摂動下での結果分布：初期解ありと初期解なしの比較}
...
\begin{tabular}{lrrrrr}
\hline
Model & Switch count & SwitchFreq & Sharpe & CVaR$_{95}$ \\
\hline
DFL-OPT-K (init=DFL-CF)   & 246 & 0.237 & 0.802 & 4.97 \\
DFL-OPT-K (no init)       & 246 & 0.237 & 0.779 & 5.01 \\
DFL-CF                    & 256 & 0.247 & 0.602 & 5.68 \\
IPO-GRAD                  & 262 & 0.253 & 0.714 & 5.48 \\
SPO+                      & 222 & 0.214 & 0.581 & 5.77 \\
PFL                       & 219 & 0.211 & 0.330 & 6.73 \\
\hline
\end{tabular}
\end{table}
